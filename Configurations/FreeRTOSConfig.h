...
//#define configSTM                           ( ( uint32_t * ) (0xF0000000 + configCPU_NR*0x100 ) )
//#define configSTM_SRC                       ( ( uint32_t * ) (0xF0038490 + configCPU_NR*0x8) )
//#define configSTM_CLOCK_HZ                  ( 100000000 )
//#define configSTM_DEBUG                     ( 1 )
//#define configCONTEXT_SRC                   ( ( uint32_t * ) 0xF0039000 )
//
//#endif /* FREERTOS_CONFIG_H */


/* old port starts here */
/*
...
#define configUSE_PREEMPTION                1
#define configUSE_IDLE_HOOK                 0
/* CPU is actually 300MHz but SPBDIV is 1 meaning divide by 2 for the
peripheral clock. */
#define configCPU_CLOCK_HZ                  ( ( unsigned long ) 300000000UL )
...
#define INCLUDE_vTaskDelay                      1
//255,30,31
#define configMAX_SYSCALL_INTERRUPT_PRIORITY    10 /* Interrupt above priority 64 are not effected by critical sections, but cannot call interrupt safe FreeRTOS functions. */
#define configKERNEL_INTERRUPT_PRIORITY         2//250//  /* This is defined here for clarity, but the value must not be changed from 2. */
